...
RUN_ENV=(
  ...
  "WINELOADER=$LOADER" "WINELOADERNOEXEC=1" "WINESERVER=$SERVER" "WINEDLLPATH=$PE"
  "DYLD_LIBRARY_PATH=${DYLD_LIBRARY_PATH:-/var/jb/usr/lib}"
  "JUICE_SKIP_WINEBOOT=${JUICE_SKIP_WINEBOOT:-1}"
  "JUICE_WINESERVER_ROOT=${JUICE_WINESERVER_ROOT:-/var/mobile/Documents/JuiceData/wineserver}"
)
mkdir -p "${JUICE_WINESERVER_ROOT:-/var/mobile/Documents/JuiceData/wineserver}"
chmod 700 "${JUICE_WINESERVER_ROOT:-/var/mobile/Documents/JuiceData/wineserver}"
